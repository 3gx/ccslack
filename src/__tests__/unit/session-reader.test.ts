...
describe('session-reader', () => {
  ...
  describe('hasTextOutput', () => {
    it('should return true for user messages', () => {
      ...
      expect(hasTextOutput(msg)).toBe(true);
    });

    it('should return true for assistant message with text block', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
    ...
    it('should return false for assistant message with only thinking', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
      ...
      expect(hasTextOutput(msg)).toBe(false);
    });

    it('should return false for assistant message with only tool_use', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
    ...
    it('should return true for assistant message with thinking and text', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
    ...
    it('should return false for message with no content', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
    ...
    it('should return false for text block with only whitespace', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
    ...
    it('should return false for empty text block', () => {
      const msg: SessionFileMessage = {
        type: 'assistant',
        uuid: '123',
        timestamp: '2024-01-01T12:00:00Z',
